...
SCALAR_FIELD_DEFAULTS: dict[str, Any] = {
    ...
    "pages_to_retrieve": 2,
    "results_per_page": 25,
    "google_scholar_pages": 5,
    "google_scholar_page_min": 1,
    "google_scholar_page_max": 100,
    "google_scholar_results_per_page": 10,
    ...
    "topic_prefilter_max_chars": 4000,
    "llm_provider": "auto",
    "decision_mode": "strict",
    "maybe_threshold_margin": 10.0,
    "run_mode": "analyze",
    "verbosity": "normal",
    "ui_settings_mode": "compact",
    "max_workers": 4,
    "discovery_workers": 0,
    "io_workers": 0,
    "screening_workers": 0,
    ...
    "google_scholar_calls_per_second": 0.2,
    ...
    "semantic_scholar_max_requests_per_minute": 120,
    "semantic_scholar_request_delay_seconds": 0.0,
    "semantic_scholar_retry_attempts": 4,
    "semantic_scholar_retry_backoff_strategy": "exponential",
    "semantic_scholar_retry_backoff_base_seconds": 2.0,
...
BOOLEAN_FIELD_DEFAULTS = {
    ...
    "ui_show_advanced_settings": False,
    "skip_discovery": False,
    "download_pdfs": False,
    "analyze_full_text": False,
    "topic_prefilter_enabled": True,
    "topic_prefilter_filter_low_relevance": False,
    "output_csv": True,
    "output_json": True,
    ...
    values.update(
        {
            ...
            "google_scholar_pages": config.google_scholar_pages,
            "google_scholar_page_min": config.google_scholar_page_min,
            "google_scholar_page_max": config.google_scholar_page_max,
            "google_scholar_results_per_page": config.google_scholar_results_per_page,
            ...
            "discovery_stage_enabled": config.discovery_stage_enabled,
            ...
            "topic_prefilter_max_chars": config.topic_prefilter_max_chars,
            "llm_provider": config.llm_provider,
            "decision_mode": config.decision_mode,
            "maybe_threshold_margin": config.maybe_threshold_margin,
            "run_mode": config.run_mode,
            "verbosity": config.verbosity,
            "ui_settings_mode": config.ui_settings_mode,
            ...
            "ui_show_advanced_settings": config.ui_show_advanced_settings,
            "download_pdfs": config.download_pdfs,
            "analyze_full_text": config.analyze_full_text,
            "topic_prefilter_enabled": config.topic_prefilter_enabled,
            "topic_prefilter_filter_low_relevance": config.topic_prefilter_filter_low_relevance,
            ...
            "google_scholar_calls_per_second": config.api_settings.google_scholar_calls_per_second,
            ...
            "topic_prefilter_model": config.api_settings.topic_prefilter_model,
            "semantic_scholar_max_requests_per_minute": config.api_settings.semantic_scholar_max_requests_per_minute,
            "semantic_scholar_request_delay_seconds": config.api_settings.semantic_scholar_request_delay_seconds,
            "semantic_scholar_retry_attempts": config.api_settings.semantic_scholar_retry_attempts,
            "semantic_scholar_retry_backoff_strategy": config.api_settings.semantic_scholar_retry_backoff_strategy,
            "semantic_scholar_retry_backoff_base_seconds": config.api_settings.semantic_scholar_retry_backoff_base_seconds,
...
def form_values_to_config(values: dict[str, Any]) -> ResearchConfig:
    ...
    return ResearchConfig(
        ...
        google_scholar_pages=as_int("google_scholar_pages", 5) or 5,
        google_scholar_page_min=as_int("google_scholar_page_min", 1) or 1,
        google_scholar_page_max=as_int("google_scholar_page_max", 100) or 100,
        google_scholar_results_per_page=as_int("google_scholar_results_per_page", 10) or 10,
        ...
        discovery_stage_enabled=as_bool("discovery_stage_enabled"),
        ai_evaluation_enabled=as_bool("ai_evaluation_enabled"),
        skip_discovery=as_bool("skip_discovery"),
        citation_snowballing_enabled=as_bool("citation_snowballing_enabled"),
        google_scholar_enabled=as_bool("google_scholar_enabled"),
        ui_show_advanced_settings=as_bool("ui_show_advanced_settings"),
        relevance_threshold=as_float("relevance_threshold", 70.0),
        topic_prefilter_enabled=as_bool("topic_prefilter_enabled"),
        ...
        topic_prefilter_max_chars=as_int("topic_prefilter_max_chars", 4000) or 4000,
        ...
        ui_settings_mode=str(values.get("ui_settings_mode", "compact") or "compact"),
        ...
        api_settings={
            ...
            "google_scholar_calls_per_second": as_float("google_scholar_calls_per_second", 0.2),
            ...
            "topic_prefilter_model": str(values.get("topic_prefilter_model", "") or "sentence-transformers/all-MiniLM-L6-v2"),
            "semantic_scholar_max_requests_per_minute": as_int("semantic_scholar_max_requests_per_minute", 120) or 120,
            "semantic_scholar_request_delay_seconds": as_float("semantic_scholar_request_delay_seconds", 0.0),
            "semantic_scholar_retry_attempts": as_int("semantic_scholar_retry_attempts", 4) or 4,
            "semantic_scholar_retry_backoff_strategy": str(values.get("semantic_scholar_retry_backoff_strategy", "exponential") or "exponential"),
            "semantic_scholar_retry_backoff_base_seconds": as_float("semantic_scholar_retry_backoff_base_seconds", 2.0),
